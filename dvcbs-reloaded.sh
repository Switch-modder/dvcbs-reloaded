...
if [ ! -f mounted/* ]; then
    ...
    wget http://ota.pvic.xyz/vic/latest/oskr.ota -P mounted/
    echo "Done downloading."
elif [ -f mounted/manifest.ini ]; then
    echo "An OTA has already been mounted here. Delete everything in the directory or build."
    exit 0
elif [ -f mounted/*.ota ]; then
...
if [ ! -f mounted/* ]; then
    echo "Downloading latest wireOS ota from Wire's server."
    wget http://ota.pvic.xyz/vic/latest/dev.ota -P mounted/
    echo "Done downloading."
elif [ -f mounted/manifest.ini ]; then
    echo "An OTA has already been mounted here. Delete everything in the directory or build."
    exit 0
...
if [ ! -f mounted/* ]; then
    echo "Downloading latest wireOS ota from Wire's server."
    wget https://ota.pvic.xyz/dvt2/2.1.0.18.ota -P mounted/
    echo "Done downloading."
elif [ -f mounted/manifest.ini ]; then
    echo "An OTA has already been mounted here. Delete everything in the directory or build."
    exit 0
...
if [ ! -f mounted/* ]; then
    echo "Downloading latest wireOS ota from Wire's server."
    wget https://ota.pvic.xyz/dvt3/2.1.0.18.ota -P mounted/
    echo "Done downloading."
elif [ -f mounted/manifest.ini ]; then
    echo "An OTA has already been mounted here. Delete everything in the directory or build."
    exit 0
...
echo "Decrypting"
openssl enc -d -aes-256-ctr -pass file:${refo}/ota.pas -md md5 -in ${dir}apq8009-robot-sysfs.img.gz -out ${dir}apq8009-robot-sysfs.img.dec.gz > /dev/null
...
mkdir ${dir}final
echo "Encrypting"
openssl enc -e -aes-256-ctr -pass file:${refo}/ota.pas -md md5 -in ${dir}apq8009-robot-sysfs.img.gz -out ${dir}final/apq8009-robot-sysfs.img.dec.gz > /dev/null
...
openssl enc -d -aes-256-ctr -pass file:${refo}/ota.pas -md md5 -in ${dir}tempSign/apq8009-robot-sysfs.img.gz -out ${dir}tempSign/apq8009-robot-sysfs.img.dec.gz > /dev/null
...
openssl enc -d -aes-256-ctr -pass file:${refo}/ota.pas -md md5 -in ${refo}/tempBoot/apq8009-robot-boot.img.gz -out ${refo}/tempBoot/apq8009-robot-boot.img.dec.gz > /dev/null
